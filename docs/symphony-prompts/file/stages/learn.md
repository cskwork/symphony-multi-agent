...
6. Append `## Wiki Updates` to the ticket — paths created/modified/removed, one line each with changelog (`merged`, `created`, `marked stale`, `dropped orphan row`, `updated invariant`).
